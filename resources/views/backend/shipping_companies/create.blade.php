...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.shipping_companies.store') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                            ...
                            <select name="countries[]" id="countries" class="form-control select2" multiple="multiple">
                                @forelse($countries as $country)
                                    <option value="{{ $country->id }}"
                                        {{ in_array($country->id, old('countries', [])) ? 'selected' : null }}>{{ $country->name }}</option>
                                @empty
                                @endforelse
                            </select>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="cost" type="number" min="0.00" class="form-control" name="cost" value="{{ old('cost') }}" >
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input id="description" value="{{ old('description') }}" class="form-control" name="description">
