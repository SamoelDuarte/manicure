                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="start_date" type="text" name="start_date" value="{{ old('start_date', $coupon->start_date ? $coupon->start_date : '') }}">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="expire_date" type="text" name="expire_date" value="{{ old('expire_date', $coupon->expire_date ? $coupon->expire_date : '') }}">
