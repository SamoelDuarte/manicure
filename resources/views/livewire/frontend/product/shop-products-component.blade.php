            ...
            <div class="shop-product-content tab-content">
                                    ...
                                    <div class="product-fruit-img">
                                        ...
                                        <div class="product-furit-action">
                                            <a wire:click.prevent="addToCart('{{ $product->id }}')"
                                               class="furit-animate-left" title="Adicionar ao Carrinho">
                ...
                <div id="grid-sidebar2" class="tab-pane fade">
                    <div class="row">
                                        ...
                                        <div class="product-list-cart-wishlist">
                                            <div class="product-list-cart">
                                                <a wire:click="addToCart('{{ $product->id }}')"
                                                   class="btn-hover list-btn-style" title="Adicionar ao Carrinho" style="cursor: pointer">
                        ...
                        @empty
                            <h3 style="">Nenhum Produto Encontrado.</h3>
                        @endforelse
                    </div>
                </div>
            </div>
