        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ route('user.update_profile') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center mb-4">
                            @if(auth()->user()->user_image)
                                ...
                                <div class="mt-2">
                                    <a href="{{ route('user.remove_image') }}" class="btn btn-sm btn-outline-danger">Remover imagen</a>
                                </div>
                            @else
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button class="button bg-dark text-white" type="submit">Atualizar</button>
                        </div>
                    </div>
                </form>
            </div>
