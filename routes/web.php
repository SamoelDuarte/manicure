...
Route::middleware(['middleware' => 'auth', 'checkCart'])->group(function() {
    ...
    Route::post('/payment_teste', [PaypalController::class, 'teste']);
    Route::get('/payment/payment_getQrCode', [PaypalController::class, 'getQrCode']);
    Route::get('/payment/statusQrCode', [PaypalController::class, 'statusQrCode']);
